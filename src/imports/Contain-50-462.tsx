import svgPaths from "./svg-51rk2cv9oi";

function Frame23() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[28px] not-italic relative shrink-0 text-[24px] text-white w-full">Gerenciamento de Despesas</p>
    </div>
  );
}
...
function Dropdown1() {
  return (
    <div className="bg-[#3a3a3a] h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="dropdown">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[40px] items-center justify-between px-[16px] py-0 relative w-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30px] not-italic relative shrink-0 text-[14px] text-center text-nowrap text-white whitespace-pre">Selecione</p>
          <Frame2 />
        </div>
      </div>
    </div>
...
function Frame22() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-white w-[162px]">Animal Vinculado</p>
      <Dropdown1 />
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[14px] text-white w-[162px]">Tipo de Receita</p>
      <Dropdown2 />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start justify-center pl-0 pr-[10px] py-0 relative w-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[20px] text-nowrap text-white whitespace-pre">Adicionar Receita</p>
          <Frame25 />
          <Frame29 />
        </div>
      </div>
...
function LabelText2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="label-text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#6b6b6b] text-[14px] text-nowrap whitespace-pre">Descrição da Receita...</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="box-border content-stretch flex flex-col items-start px-[48px] py-[8px] relative rounded-[8px] shrink-0" data-name="Frame">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-nowrap whitespace-pre">Excluir</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="box-border content-stretch flex flex-col items-start px-[48px] py-[8px] relative rounded-[8px] shrink-0" data-name="Frame">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[16px] text-nowrap whitespace-pre">Cancelar</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col items-start px-[48px] py-[8px] relative rounded-[8px] shrink-0" data-name="Frame">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#1a1a1a] text-[16px] text-nowrap whitespace-pre">Adicionar Despesa</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="box-border content-stretch flex items-start justify-between pb-0 pt-[16px] px-0 relative shrink-0 w-full" data-name="Frame">
      <Frame13 />
      <Frame14 />
    </div>
  );
...
function Contain() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[24px] items-start px-0 py-[48px] relative shrink-0 w-[1140px]" data-name="Contain">
      <Frame23 />
      <Criar />
    </div>
  );
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[28px] not-italic relative shrink-0 text-[24px] text-white w-full">Despesas Cadastradas</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="relative shrink-0 w-[200px]">Data</p>
      <p className="relative shrink-0 w-[200px]">Descrição</p>
      <p className="relative shrink-0 w-[250px]">Animal Vinculado</p>
      <p className="relative shrink-0 w-[200px]">Tipo</p>
      <p className="relative shrink-0 w-[200px]">Valor</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="box-border content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold items-center justify-between leading-[28px] not-italic px-[16px] py-0 relative shrink-0 text-[16px] text-white w-[1141px]">
      <Frame9 />
...
function Frame10() {
  return (
    <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center leading-[20px] not-italic relative shrink-0 text-[14px] text-white">
      <p className="relative shrink-0 w-[200px]">01/01/2024</p>
      <p className="relative shrink-0 w-[200px]">Venda de potro</p>
      <p className="relative shrink-0 w-[250px]">Relâmpago</p>
      <p className="relative shrink-0 w-[200px]">Venda de Cavalo</p>
      <p className="relative shrink-0 w-[200px]">R$ 10.000,00</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-[1141px]" data-name="Frame">
...
function Frame17() {
  return (
    <div className="bg-[#1a1a1a] box-border content-stretch flex flex-col gap-[16px] items-start p-[16px] relative rounded-[16px] shrink-0 w-[1170px]" data-name="Frame">
      <Frame8 />
      <Frame16 />
    </div>
  );
